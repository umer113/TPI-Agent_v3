...
"– Responses should feel clean, professional, and scannable — like a helpful assistant, not a blog post."
    ...
    "• Ask for clarification if user input is unclear."
    ...
    "• 5 new commemorations announced (including Korean War 75th)\n"
    "• 4 funding rounds opened for veteran groups\n"
    "• 2 major healthcare access updates\n"
    "• 1 award nomination call for veteran employment\n"
